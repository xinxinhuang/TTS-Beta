...
namespace TeeTime.Migrations
{
    ...
    [Migration("20250330025604_AddPlayerColumnsToStandingTeeTimeRequests")]
    partial class AddPlayerColumnsToStandingTeeTimeRequests
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TeeTime.Models.Reservation", b =>
                {
                    ...
                    b.Property<int?>("StandingRequestID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TeeTime.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("TeeTime.Models.StandingTeeTimeRequest", "StandingTeeTimeRequest")
                        .WithMany()
                        .HasForeignKey("StandingRequestID")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("StandingTeeTimeRequest");
